...
//! use claude_agent_sdk::types::{PermissionResult, PermissionResultAllow, ToolPermissionContext};
//! use claude_agent_sdk::Result;
//! use async_trait::async_trait;
//!
...
/// ```no_run
/// use claude_agent_sdk::callbacks::PermissionCallback;
/// use claude_agent_sdk::types::{PermissionResult, PermissionResultAllow, PermissionResultDeny, ToolPermissionContext};
/// use claude_agent_sdk::Result;
/// use async_trait::async_trait;
///
