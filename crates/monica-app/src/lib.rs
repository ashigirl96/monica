...
fn specta_builder() -> tauri_specta::Builder<tauri::Wry> {
    tauri_specta::Builder::new()
        .commands(tauri_specta::collect_commands![
            ...
            commands::text::list_text_artifacts,
            commands::text::get_text_artifact,
            commands::text::create_text_artifact,
            commands::text::update_text_artifact,
            commands::text::promote_text_record_to_intent_seed,
            commands::text::text_artifact_type_options_command,
            commands::text::intent_seed_status_options_command,
            commands::text::export_personal_space,
