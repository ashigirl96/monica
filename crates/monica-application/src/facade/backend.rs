use crate::ports::{
    ...
    NoteStore, NotificationOutboxStore, PendingLaunchStore, ProjectRepository, PullRequestSyncStore,
    ShellScaffolding,
...
pub trait Backend {
    ...
    type Outputs: TaskRunOutputs + ShellScaffolding + ExplanationOutputs;
