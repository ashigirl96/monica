use crate::ports::{
    AgentDecoders, EventRepository, GitGateway, NotificationOutboxStore, ProjectRepository,
    PullRequestSyncStore, ShellScaffolding, TaskBoardQuery, TaskRunStore, TaskStore,
