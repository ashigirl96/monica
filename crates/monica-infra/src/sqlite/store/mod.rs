...
pub(super) const TASK_RUN_COLUMNS: &str =
    "id, task_id, agent, branch, worktree_path, status, wait_reason,      settings_path, provider_session_id, terminal_tab_id, last_event_name, last_event_at, pending_stop, metadata_json,      created_at, updated_at";
