...
- command historyをrun artifactに保存
...
raw terminal transcript: optional artifact file
large logs: artifact files
```
...
DBには構造化Eventを保存し、大きなpayloadはartifact fileへ逃がす。
