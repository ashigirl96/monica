...
export const STATUS_META: Record<DisplayStatus, StatusMeta> = {
  ...
  active: { label: "active", colorVar: "--st-running", order: 5, pulse: false },
  inbox: { label: "inbox", colorVar: "--st-inbox", order: 6, pulse: false },
  failed: { label: "failed", colorVar: "--st-failed", order: 7, pulse: false },
  stopped: { label: "stopped", colorVar: "--st-stopped", order: 8, pulse: false },
  done: { label: "done", colorVar: "--st-done", order: 9, pulse: false },
  archived: { label: "archived", colorVar: "--st-archived", order: 10, pulse: false },
};
